# Spring 2022 Intro to Internet Programming — Assignment 2
...
In both cases, the user must be able to enter into an input box how much rice they would like to make and the page must respond in real time, as the user types or hits the up and down arrow keys on their keyboard, with how much water to use. A ratio of rice to water must be indicated in all pages. Ignore ratios associated with olive oil.
...
* `gulp serve` must trigger the dev track.
...
## ❖・Due・❖
Wednesday, 26 March 2021, at 10:00 AM.
